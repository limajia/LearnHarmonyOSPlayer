...
typedef struct SDL_Aout_Opaque {
    ...
    SLBufferQueueItf   slBufferQueueItf;
...
static int aout_thread_n(SDL_Aout *aout)
{
    ...
    SLBufferQueueItf  slBufferQueueItf = opaque->slBufferQueueItf;
...
static void aout_opensles_callback(SLBufferQueueItf caller, void *pContext)
{
    SDLTRACE("%s\n", __func__);
...
static int aout_open_audio(SDL_Aout *aout, const SDL_AudioSpec *desired, SDL_AudioSpec *obtained)
{
    ...
    const SLInterfaceID ids2[] = { SL_IID_BUFFERQUEUE, SL_IID_VOLUME, SL_IID_PLAY };
    ...
    ret = (*slPlayerObject)->GetInterface(slPlayerObject, SL_IID_BUFFERQUEUE, &opaque->slBufferQueueItf);
