...
typedef struct SDL_AMediaCodec
{
    ...
    ssize_t                 (*func_writeInputData)(SDL_AMediaCodec* acodec, size_t idx, const uint8_t *data, size_t size,int64_t timeoutUs);
...
ssize_t                 SDL_AMediaCodec_writeInputData(SDL_AMediaCodec* acodec, size_t idx, const uint8_t *data, size_t size,int64_t timeoutUs);
